...
window.ChroniclerTranslations['zh-TW'] = {
    ...
    dissolveFolderConfirm: '確定要解散資料夾「{0}」嗎？\n資料夾內的 {1} 個項目將返回根目錄。',
    folderDissolvedSuccess: '資料夾已解散，項目已返回根目錄',
    folderDissolveError: '資料夾解散失敗',
    deleteFolderConfirm: '確定要刪除資料夾「{0}」嗎？\n資料夾內的 {1} 個項目也會一起被刪除！',
    deleteFolderDoubleConfirm: '⚠️ 此操作無法復原！\n確定要刪除資料夾及其所有內容嗎？',
    ...
    deleteFolders: '刪除資料夾',
    deleteFoldersConfirm: '確定要刪除 {0} 個資料夾及其內容嗎？\n此操作無法復原！',
    foldersDeletedSuccess: '已刪除 {0} 個資料夾',
    foldersDissolvedAndMovedComplete: '已解散資料夾並移動 {0} 個項目到「{1}」',
    foldersDissolvedToRootComplete: '已解散資料夾，內容已返回根目錄',
    moveSelectedFolders: '將選取的 {0} 個資料夾移動到：',
    moveSelectedItems: '將選取的 {0} 個項目移動到：',
    selectedMixed: '已選取 {0} 個項目和 {1} 個資料夾',
    selectedFoldersOnly: '已選取 {0} 個資料夾',
