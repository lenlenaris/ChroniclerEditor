...
window.ChroniclerTranslations['zh-TW'] = {
    ...
    toggleFavorite: '設定為最愛',
    foldersCannotBeAddedToFavorites: '資料夾無法加入最愛',

    // 資料夾相關
    moveToFolder: '移動',
    selectTargetFolder: '選擇目標資料夾',
    createNewFolder: '創建新資料夾',
    moveToRoot: '移動到根目錄', 
    ...
    deleteFolder: '刪除資料夾',
    enterNewFolderName: '請輸入新的資料夾名稱',
    folderRenamedSuccess: '資料夾重新命名成功',
    folderRenameError: '資料夾重新命名失敗',
    dissolveFolderConfirm: '確定要解散此資料夾嗎？資料夾內的項目將返回根目錄。',
    folderDissolvedSuccess: '資料夾已解散，項目已返回根目錄',
    folderDissolveError: '資料夾解散失敗',
    deleteFolderConfirm: '確定要刪除此資料夾嗎？資料夾內的項目也會一起被刪除！',
    deleteFolderDoubleConfirm: '⚠️ 此操作無法復原！確定要刪除資料夾及其所有內容嗎？',
    folderDeletedSuccess: '資料夾及其內容已刪除',
    folderDeleteError: '資料夾刪除失敗',
    cannotMixSelectTypes: '不能同時選取角色卡和資料夾',
    dissolveFolders: '解散資料夾',
    deleteFolders: '刪除資料夾',
    dissolveFoldersConfirm: '確定要解散選取的資料夾嗎？',
    foldersDeletedSuccess: '資料夾刪除成功',
    foldersDissolvedAndMovedComplete: '已解散資料夾並移動內容',
    foldersDissolvedToRootComplete: '已解散資料夾，內容已返回根目錄',
    ...
    // 新的批量編輯按鈕
    selectAllCharacters: '全選角色',
    selectAllWorldBooks: '全選世界書', 
    selectAllNotebooks: '全選筆記本',
    selectAllFolders: '全選資料夾',
    newFolder: '新建資料夾',
    noFoldersInSubfolder: '子資料夾中沒有資料夾可選',
    noFoldersToSelect: '沒有資料夾可選擇',
    folderOpen: '展開資料夾',
    rightClickCopy: '複製',
    rightClickDelete: '刪除',
    ...
    noContentVersions: '額外版本僅供備份自用，匯出時只會包含當前主內容。',
    ...
    versionNotePlaceholder: '備註標題（選填）',
    versionNote: '備註',
    ...
    pleaseSelectTarget: '請選擇要移動到的目標位置',
    selectedTarget: '已選擇',
    confirmMove: '確認移動',
    ...
    worldbookBatchMode: '批量編輯',
    worldbookExitBatchMode: '退出批量編輯',
    ...
    presetBatchMode: '批量編輯',
    presetExitBatchMode: '退出批量編輯',
    ...
    presetBatchDeleteConfirm: '確定要永久刪除 $1 個提示詞嗎？\n\n⚠️ 刪除後將無法復原！',
    presetBatchDeleteSuccess: '成功刪除了 $1 個提示詞',
    ...
    presetBatchCopySuccess: '成功複製 $1 個提示詞',
    movePromptSuccess: '已將提示詞「$1」移動到「$2」',
    movePromptFailed: '移動提示詞失敗',
    copyPrompt: '複製提示詞',
    movePrompt: '移動提示詞',
    promptCopied: '提示詞已複製',
    noMatchingPresets: '沒有符合的預設',
    ...
    googleServicesInitFailed: 'Google 服務初始化失敗，請稍後再試',
    loginFailed: '登入失敗',
    unknownError: '未知錯誤',
    googleLogoutSuccess: '已登出 Google 帳號',
    logoutFailed: '登出失敗',
    notLoggedInGoogle: '未登入，請先連接 Google 帳號',
    backupUploadSuccess: '備份上傳成功！',
    uploadFailed: '上傳失敗',
    backupNotFound: '未找到備份檔案',
    backupListFailed: '無法獲取備份列表',
    backupGenerationFailed: '無法產生備份資料',
    searchFolderFailed: '搜尋資料夾失敗',
    createFolderFailed: '建立資料夾失敗',
    fileUploadFailed: '檔案上傳失敗',
    fileListFailed: '列出檔案失敗',
