...
window.ChroniclerTranslations['en-US'] = {
    ...
    versionNotePlaceholder: 'Note (optional)',
    versionNote: 'Note',
    ...
    privateStories: 'Secret Stories',
    addPrivateStory: 'Add Secret Story',
    privateStory: 'Secret Story',
    unlockPrompt: 'A phrase to introduce this story',
    unlockPromptPlaceholder: 'When to hear this story?',
    ...
    promptAdded: 'Prompt inserted',
    promptRemoved: 'Prompt removed from list',
    deletePrompt: 'Delete Prompt',
    cannotDeleteMarker: 'Cannot delete marker prompt',
    confirmDeletePrompt: 'Are you sure you want to permanently delete the prompt "$1"? This action cannot be undone.',
